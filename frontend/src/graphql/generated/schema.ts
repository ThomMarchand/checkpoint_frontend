...
export type CountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', id: number, emoji: string, code: string, name: string, continent?: { __typename?: 'Continent', name: string, id: number } | null }> };
